...
public class Race extends Statistics
{
    ...
    public int racePts;
    public String venue;
    public Driver[] d = new Driver[2];      // a race can be raced by 2 drivers for a team at a time
    public Car c;
    String raceData;                        // variable for storing the data into the files
    ...
    public Race(Driver d1, Driver d2, String venue, Car c, int res1, int res2) throws IOException
    {
        ...
        this.r_id = Ferrari.countRace;
        this.c = c;
        this.d[0].result[this.r_id] = res1;    // pehle driver ka result ha kyuki uska object iske aandar banaya ha
        this.d[1].result[this.r_id] = res2;    // dusre driver ka result ha kyuki uska object iske aandar banaya ha
        this.d[0].earnings += getPrize(res1);  // pehle driver ki earning ha kyuki uska object iske aandar banaya ha
        this.d[1].earnings += getPrize(res2);  // dusre driver ki earning ha kyuki uska object iske aandar banaya ha
