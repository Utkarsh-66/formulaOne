...
public class TestClass extends Ferrari //TestClass extending from Ferrari
{
    public static void main(String[] args) throws IOException
    {
        ...
        System.out.println("\n\n This is JGarage. Created by Uttu_Gupta");
        System.out.println("Welcome to Scuderia Ferrari Formula One team.\n\n");

        while (true)     // first while loop for selecting the inputs
        {
    ...
    // driverMenu func is defined here.It is made static
    static void driverMenu() throws IOException {
        ...
        while (true) {
            ...
            System.out.println(
                    "[1] View Driver List [2] Create Driver [3] View Driver Info 5 [4] Exit");
            System.out.print("[Choice] : ");
            opt = sc.nextInt();              //taking input for the options

            if (opt == 1)                    // to display about drivers
                Ferrari.viewDrivers();
            else if (opt == 2)
    ...
    static void raceMenu() throws IOException {
        ...
        while (true) {
            ...
            System.out.println("[1] View Race List [2] Enter Race Data [3] View Race Data [4] Exit");
            System.out.print("[Choice] : ");
            opt = sc.nextInt();
            if (opt == 1)
                Ferrari.viewRaces();
    ...
    static void carMenu() throws IOException {
        ...
        while (true) {
            ...
            System.out.println(
                    "[1] View Cars List [2] Enter Car Setting [3] View Car Setting [4] Exit");
            System.out.print("[Choice] : ");
            opt = sc.nextInt();
            if (opt == 1)
                Ferrari.viewCars();
