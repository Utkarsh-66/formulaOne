 ...
 * Scuderia Ferrari's 2023 Formula 1 season.
 * 
 */
...
{   
    ...
    public static double budget = 300000000; // 300 million
    public static int teamPts = 0;
    public static String sponsor;
    final public String color = "Red, White, Black";
    final public int year = 2022;

    abstract void setInfo() throws IOException;       // Abstract function should be defined later to setinformation

    abstract void dispInfo();                         // Abstract function should be defined later to displayinformation
    
    public static Driver[] drivers = new Driver[5];   // Object for Driver class
    public static Race[] races = new Race[23];        // object for Races class
    public static Car[] cars = new Car[4];            // object for Cars class
    
    class customExc extends Exception                 // custom class for throwing exception
    {           
        customExc(String c)
        {
            super(c);
    ...
    {
        System.out.println("\t\t  SCUDERIA FERRARI - 2023 TEAM PROFILE");
